                    ...
                    try {
                      ...
                      while (retries < 8) {
                        ...
                        if (retries === 0) {
                          ...
                          setToast({ message: `⏳ Reports generating... ${completed}/${total} ready (retry ${retries}/8, ${elapsed}s)`, type: 'info', duration: 120000 });
                        }
                      ...
                      if (data?.success && data?.dailyData) {
                        ...
                        if (setAdsIntelData && data.reports) {
                          setAdsIntelData(prev => {
                            ...
                            // Only write API data if no CSV upload exists for that type,
                            // or existing data was also API-sourced (safe to refresh)
