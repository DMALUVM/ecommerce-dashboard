...
table { width: 100%; border-collapse: collapse; font-size: 8.5pt; margin: 14px 0 18px; border: 1px solid #d1d5db; }
...
td { padding: 7px 10px; border-bottom: 1px solid #f3f4f6; font-size: 8.5pt; color: #374151; }
