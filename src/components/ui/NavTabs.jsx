...
const NavTabs = ({
  ...
  const analyticsViews = ['trends', 'yoy', 'skus', 'profitability', 'unit-economics', 'ads'];
  ...
  const analyticsItems = [
    ...
    {
      view: 'unit-economics', label: 'Unit Economics', icon: Target,
      disabled: Object.keys(allDaysData || {}).length < 1,
